<template>
  ...
  <a-modal v-model:visible="visible" title="余票信息" @ok="handleOk" ok-text="确认" cancel-text="取消">
...
const onDelete = (record) => {
  axios.delete('/business/admin/daily-train-ticket/delete/' + record.id).then((data) => {
    if (data.success) {
...
const handleOk = () => {
  axios.post('/business/admin/daily-train-ticket/save', dailyTrainTicket.value).then((data) => {
    if (data.success) {
...
const handleQuery = (param) => {
  ...
  loading.value = true
  axios
    .get('/business/admin/daily-train-ticket/query-list', {
      params: {
        page: param.page,
        size: param.size
      }
